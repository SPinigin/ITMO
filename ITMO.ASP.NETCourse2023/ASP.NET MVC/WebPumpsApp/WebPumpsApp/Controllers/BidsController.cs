...
namespace WebPumpsApp.Controllers
{
    public class BidsController : Controller
    {
        ...
        public BidsController(PumpsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BidId,Name,PumpHead,bidDate")] Bid bid)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BidId,Name,PumpHead,bidDate")] Bid bid)
        {
            if (id != bid.BidId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PumpsContext.Bids'  is null.");
            }
            var bid = await _context.Bids.FindAsync(id);
            if (bid != null)
            {
